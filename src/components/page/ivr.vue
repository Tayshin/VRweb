    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>一体机</el-breadcrumb-item>
                                ...
                                <td>
                                    <div class="tab-content">
                                        <ul class="category">
                                            ...
                                            <li>
                                                <span class="para-name">CPU</span>
                                                <span class="para-val">{{data.cpu}}</span>
                                            </li>
                                            <li>
                                                <span class="para-name">内存</span>
                                                <span class="para-val">{{data.memory}}</span>
                                            </li>
                                            <li>
                                                <span class="para-name">电池容量</span>
                                                <span class="para-val">{{data.battery_capacity}}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
